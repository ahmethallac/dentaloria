...
export type ClinicTreatmentsHandle = {
  save: () => Promise<void>;
};
...
const ClinicTreatmentsManager = forwardRef<ClinicTreatmentsHandle, Props>(
  ({ clinicId, selections, onChanged }, ref) => {
    ...
    useImperativeHandle(ref, () => ({ save }), [selected, clinicId]);
...
ClinicTreatmentsManager.displayName = "ClinicTreatmentsManager";

export default ClinicTreatmentsManager;
